    ...
    return (
        <div className='container'>
            ...
            <div className='columns is-multiline'>
                <div className='column is-8-tablet is-offset-2-tablet  p-4 has-text-centered'>
                ...
                <div className='column is-8-tablet is-offset-2-tablet p-4 mb-2 has-text-centered'>
